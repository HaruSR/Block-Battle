...
public class DragAndDrop : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IDropHandler
{
    ...
    public void OnDrop ( PointerEventData eventData )
    {
        ...
        foreach ( var hit in raycastResults )
        {
            ...
            {
                Debug.Log(this.gameObject.name+" local position:"+this.gameObject.transform.localPosition);
                Debug.Log(this.gameObject.name+" local position:"+this.gameObject.transform.position);
